function drawGraph(data) {
    ...
    document.getElementsByTagName("h3")[0].innerHTML = "Precipitation by Year, 2012-2015";
    ...
    let lineLegendLabels = plot.append("g")
    .selectAll("text")
    .data(byYear)
    .enter()
    .append("text")
    .attr("x", (d) => xScale(d3.max(d[1], d=>d.dayOfYear)))
    .attr("dx", 5)
    .attr("y", (d) => yScale(d3.max(d[1], d=>d.cumulativePrecipitationByYear)))
    .style("fill", d=>colorScale(d[0])) // key
    .text(d=>d[0]); // key
